/*
 Twitter Bootstrap Toogle Buttons 0.0.0
...
TwbsToggleButtons.prototype._initializeDOM=function(){var a=this.$_element.find(this._options.twbsBtnSelector).filter("."+TwbsToggleButtons.ACTIVE_CLASS()).toArray();1<a.length&&this._getInputType()===TwbsToggleButtons.TYPE_RADIO()&&(a=[a.pop()]);this._resetDOM(a)};
TwbsToggleButtons.prototype._eventClick=function(a){var b=this.$_element.find(this._options.twbsBtnSelector).filter("."+TwbsToggleButtons.ACTIVE_CLASS()).toArray();a=a.currentTarget;this._getInputType()===TwbsToggleButtons.TYPE_RADIO()?(b=[a],a.classList.contains(TwbsToggleButtons.ACTIVE_CLASS())&&0===this.$_element.find(this._options.twbsBtnSelector).find(":input[required]").length&&(b=[])):a.classList.contains(TwbsToggleButtons.ACTIVE_CLASS())&&-1!==b.indexOf(a)?b.splice(b.indexOf(a),1):b.push(a);
this._resetDOM(b);return!1};TwbsToggleButtons.prototype._activateButton=function(a){void 0!==a.dataset.twbsToggleButtonsClassActive&&0<a.dataset.twbsToggleButtonsClassActive.length?a.classList.add(a.dataset.twbsToggleButtonsClassActive):this._options.classActive.forEach(function(b){a.classList.add(b)});this._options.classInactive.forEach(function(b){a.classList.remove(b)});a.classList.add(TwbsToggleButtons.ACTIVE_CLASS());a.setAttribute("aria-pressed","true");$(a).find(":input").attr("checked","checked")};
TwbsToggleButtons.prototype._deactivateButton=function(a){void 0!==a.dataset.twbsToggleButtonsClassActive&&0<a.dataset.twbsToggleButtonsClassActive.length&&a.classList.remove(a.dataset.twbsToggleButtonsClassActive);this._options.classActive.forEach(function(b){a.classList.remove(b)});this._options.classInactive.forEach(function(b){a.classList.add(b)});a.classList.remove(TwbsToggleButtons.ACTIVE_CLASS());a.setAttribute("aria-pressed","false");$(a).find(":input").attr("checked",null)};(function(a){null==a.fn.twbsToggleButtons&&(a.fn.twbsToggleButtons=function(b){var c=["clear","destroy"];b=b||{};if("object"===typeof b)return this.each(function(){var c=a.extend(!0,{},b);void 0===a(this).data("twbsToggleButtons")?new TwbsToggleButtons(a(this),c):(c=a(this).data("twbsToggleButtons"),null===c&&window.console&&console.error&&console.warn("Error on Initialization as TwbsToggleButtons: "+this))}),this;if("string"===typeof b){var d,e=Array.prototype.slice.call(arguments,1);this.each(function(){var c=
